...
</style></head><body><main><header><div class="brand">AHILL LAB / CUTGUARD {e(report['version'])}</div><h1>확인할 구간을,<br>명확하게.</h1><p class="filename">{e(source_name)}</p><p class="muted">{e(media_line)}</p></header>
